...
class Ui_EditKey(object):
    def setupUi(self, EditKey):
        ...
        self.cancelsavebuttons.setStandardButtons(
        ...
        EditKey.setTabOrder(self.extracaptions, self.deletecaption)
    ...
    def retranslateUi(self, EditKey):
        ...
        self.lbl_6.setText(
            _translate("EditKey", "(Better to add CSS class and put style info in the keyboard stylesheet)")
        )
        ...
        self.actiontabs.setTabText(
            self.actiontabs.indexOf(self.long), _translate("EditKey", "Press and hold")
        )
